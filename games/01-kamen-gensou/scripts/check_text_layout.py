...
if __name__ == '__main__':
    ...
    p.save(root/'text-layout-report.json', report)
    p.require(not report['failures'] and not report['unclassified_string_commands'], 'Text layout audit failed')
    print('PASS: all script string slots classified; all speaker names and menu rows fit.')
