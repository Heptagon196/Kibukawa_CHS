...
def ensure_dependency(item):
    ...
    request = urllib.request.Request(item["url"], headers={"User-Agent": "Kibu3ZhCN-font-build/1.0"})
...
def build_font(pack, out):
    ...
    notice = ("Kibu3 Dialogue Pixel 16 - a subset/format conversion of GNU Unifont " + lock["version"] + "\n"
