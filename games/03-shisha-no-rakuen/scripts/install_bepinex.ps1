...
if ($paths.Id -ne 'kibu3') { throw 'This installer is only for kibu3' }
$gameRoot = $paths.Game
if (!$CheckOnly -and (Get-Process kibu3 -ErrorAction SilentlyContinue)) { throw 'Exit kibu3 before installing.' }
...
if ($files.Name -notcontains 'BepInEx/plugins/Kibu3ZhCN/Kibu3ZhCN.dll') { throw 'Third-game translation plugin missing' }
$targets = @{}
...
if (Get-Process kibu3 -ErrorAction SilentlyContinue) { throw 'kibu3 started during preflight; installation cancelled' }
