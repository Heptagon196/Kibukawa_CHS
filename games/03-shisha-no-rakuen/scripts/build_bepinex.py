"""Build and validate the kibu3 runtime translation without installing/launching."""
import argparse
import base64
import collections
import io
...
def main():
    ...
    payload['README_Kibu3_汉化安装.txt'] = p.WORK/'bepinex/README_INSTALL.txt'
    ...
    archive = release/'Kibu3_ZhCN_BepInEx_Full.zip'
