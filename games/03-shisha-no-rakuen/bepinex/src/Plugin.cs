...
namespace Kibu1ZhCN
{
    [BepInPlugin(Id, "Kibu3 Simplified Chinese", "0.2.3")]
    [BepInProcess("kibu3.exe")]
    public sealed class Plugin : BaseUnityPlugin
    {
        public const string Id = "local.kibu3.zhcn";
        ...
        private void Awake()
        {
            ...
            try
            {
                ...
                string managed = Path.Combine(Paths.GameRootPath, "kibu3_Data", "Managed", "Assembly-CSharp.dll");
                string archive = Path.Combine(Paths.GameRootPath, "kibu3_Data", "StreamingAssets", "scratchpad");
