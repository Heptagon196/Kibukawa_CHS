...
public static class MenuHookTests
{
    ...
    public static void Main(string[] args)
    {
        ...
        AppDomain.CurrentDomain.AssemblyResolve += delegate(object sender, ResolveEventArgs e) {
            ...
            foreach (string folder in new [] { Path.Combine(framework,"BepInEx/core"),Path.Combine(root,"kibu6_Data/Managed"),pluginDir })
            {
    ...
    {
        Assembly game=Assembly.LoadFrom(Path.Combine(root,"kibu6_Data/Managed/Assembly-CSharp.dll"));
        ...
        Assembly plugin=Assembly.LoadFrom(Path.Combine(pluginDir,"Kibu6ZhCN.dll"));
