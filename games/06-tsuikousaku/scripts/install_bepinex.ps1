...
if ($paths.Id -ne 'kibu6') { throw 'This installer is only for kibu6' }
$gameRoot = $paths.Game
if (!$CheckOnly -and (Get-Process kibu6 -ErrorAction SilentlyContinue)) { throw 'Exit kibu6 before installing.' }
...
if ($files.Name -notcontains 'BepInEx/plugins/Kibu6ZhCN/Kibu6ZhCN.dll') { throw 'Sixth-game translation plugin missing' }
$targets = @{}
...
if (Get-Process kibu6 -ErrorAction SilentlyContinue) { throw 'kibu6 started during preflight; installation cancelled' }
