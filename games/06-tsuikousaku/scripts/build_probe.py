"""Compile/package a sixth-game bootstrap probe using the shared build layer.
...
def main():
    ...
    target = dict(config['bepinex'], assembly='Kibu6Bootstrap.dll', plugin_directory='Kibu6Bootstrap')
    ...
    archive = release/'Kibu6_Bootstrap_NOT_TRANSLATION.zip'
    shared.archive_package(package, archive)
    p.require(p.game_hashes() == before, 'Sixth-game files changed during build')
