...
namespace Kibu1ZhCN {
 ...
 public static class LegacyFontRenderer { public static BitmapFontAtlas Small; public static int X,Y; public static float Scale; public static float? Top; public static bool Draw(object o,char[] c,int x,int y,object a,BitmapFontAtlas f,float s,BitmapFontAtlas small=null,float? top=null) { X=x;Y=y;Scale=s;Top=top;Small=small;return false; } }
}
namespace Kibu8ZhCN {
