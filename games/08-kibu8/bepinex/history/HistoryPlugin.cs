...
namespace KibukawaHistory
{
    ...
    [BepInDependency("local.kibu8.zhcn", BepInDependency.DependencyFlags.HardDependency)]
    public sealed class HistoryPlugin : Gmode20050817HistoryRuntime
    {
        ...
        {
            Type ui=AccessTools.TypeByName("Kibu8ZhCN.UiLocalization");
