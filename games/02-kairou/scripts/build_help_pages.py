"""Compile independently verified kibu2 help sprites (static asset review only)."""
import json
import UnityPy
import pipeline as p
ROOT = p.WORK / 'bepinex'
BUNDLE = 'kibu2_Data/StreamingAssets/prefab/howtoplay'
SHA256 = '5b23cd44258cf91060f9bcb6a476fa8a0ad217fb2c5a6f26c07fc8db76bd3758'
IDS = [1690081622876281709, 8350837952461843977, -7503435327397368138, 2115760025779521281]
# Independently transcribed against the four kibu2 texture exports on 2026-09-06.
# White text is visible after compositing the RGBA export against navy blue.
PAGES = [
 dict(title='操作说明', subtitle='〈侦探·癸生川凌介事件谭 第2卷《海楼馆杀人事件》〉',
...
def build_help_pages():
    ...
    p.require(p.sha(bundle.read_bytes()) == SHA256, 'Second-game help bundle mismatch')
    ...
    p.require([r['m_PathID'] for r in refs] == IDS, 'Second-game help order/count mismatch')
    entries, pages = [], []
    ...
    source = '''// Generated from independently reviewed kibu2 help content by build_help_pages.py.
namespace Kibu1ZhCN {
