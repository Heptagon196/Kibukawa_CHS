// Generated from independently reviewed kibu4 help content by build_help_pages.py.
namespace Kibu1ZhCN {
    ...
    public static class HelpPages {
        public static readonly HelpPage[] All = new HelpPage[] {
            new HelpPage { Name="howtoplay_keyguide_steam_00", Title="操作说明", Subtitle="〈侦探·癸生川凌介事件谭 第4卷《白鹭红羽》〉", Rows=new string[][] { new [] { "START 按钮", "选项" }, new [] { "A 按钮", "确认／推进文字" }, new [] { "L 摇杆／方向键", "移动光标" }, new [] { "L 摇杆向下／方向键下", "跳过文字" }, new [] { "R", "切换声音 ON／OFF" } }, Footer="本游戏不支持自动保存。\n退出前，请使用游戏内的存档功能保存进度。", Body="" },
            new HelpPage { Name="howtoplay_keyguide_steam_01", Title="操作说明", Subtitle="〈侦探·癸生川凌介事件谭 第4卷《白鹭红羽》〉", Rows=new string[][] { new [] { "ESC", "选项" }, new [] { "Z / SPACE / L SHIFT / L CTRL", "确认／推进文字" }, new [] { "W A S D / ↑ ← ↓ →", "移动光标" }, new [] { "S / ↓", "跳过文字" }, new [] { "E", "切换声音 ON／OFF" } }, Footer="本游戏不支持自动保存。\n退出前，请使用游戏内的存档功能保存进度。", Body="" },
