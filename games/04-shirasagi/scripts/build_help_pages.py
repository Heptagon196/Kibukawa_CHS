"""Compile independently verified kibu4 help sprites (static asset review only)."""
import json
import UnityPy
import pipeline as p
ROOT = p.WORK / 'bepinex'
BUNDLE = 'kibu4_Data/StreamingAssets/prefab/howtoplay'
SHA256 = 'cbd2eba261cee0acc0e0a8098b9cf36546299aa5bbb088c3a7cadf80f50427c9'
IDS = [-3824847761605379513, 3658362516025441092, -962433540712524955, -570631712419137018]
# Independently transcribed against the four kibu4 texture exports on 2026-09-06.
# White text is visible after compositing the RGBA export against navy blue.
PAGES = [
 dict(title='操作说明', subtitle='〈侦探·癸生川凌介事件谭 第4卷《白鹭红羽》〉',
...
def build_help_pages():
    ...
    p.require(p.sha(bundle.read_bytes()) == SHA256, 'Fourth-game help bundle mismatch')
    ...
    p.require([r['m_PathID'] for r in refs] == IDS, 'Fourth-game help order/count mismatch')
    entries, pages = [], []
    ...
    source = '''// Generated from independently reviewed kibu4 help content by build_help_pages.py.
namespace Kibu1ZhCN {
