...
def ensure_dependency(item):
    ...
    request = urllib.request.Request(item["url"], headers={"User-Agent": "Kibu4ZhCN-font-build/1.0"})
...
def build_font(pack, out):
    ...
    notice = ("Kibu4 Dialogue Pixel 16 - a subset/format conversion of GNU Unifont " + lock["version"] + "\n"
