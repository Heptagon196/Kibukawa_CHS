"""Compile/package a seventh-game bootstrap probe using the shared build layer.
...
def main():
    ...
    target = dict(config['bepinex'], assembly='Kibu7Bootstrap.dll', plugin_directory='Kibu7Bootstrap')
    ...
    archive = release/'Kibu7_Bootstrap_NOT_TRANSLATION.zip'
    shared.archive_package(package, archive)
    p.require(p.game_hashes() == before, 'Seventh-game files changed during build')
