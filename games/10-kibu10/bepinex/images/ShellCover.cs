...
namespace Kibu10ZhCN.Images
{
    ...
    {
        private const string Owner = "heptagon.kibu10.shellcover";
        ...
        internal static void Initialize(string folder)
        {
            ...
            try
            {
                replacement = NativeArtwork.LoadNative(Path.Combine(folder, "titleimage-zh.png"), 354, 354);
                replacement.name = "kibu10_titleimage_zh";
        ...
        private static Sprite Translate(Sprite original)
        {
            ...
            translated.name = "kibu10_titleimage_zh_sprite";
