...
& $compiler /nologo ("/out:" + $localTest) (Join-Path $seriesPath 'games/08-kibu8/bepinex/tests/History8Tests.cs') (Join-Path $seriesPath 'engine/adapters/gmode-20050817/src/HistoryCapture.cs') (Join-Path $seriesPath 'engine/adapters/gmode-v2/src/HistoryState.cs') (Join-Path $seriesPath 'engine/history/src/HistoryBuffer.cs') (Join-Path $seriesPath 'engine/history/src/RuntimePolicy.cs')
