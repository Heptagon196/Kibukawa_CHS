...
2026-09-23：用户确认本作翻译完成。正式发布 0.1.39，包含最终罗马音谜题提示、释迦堂译注及排版修订；已安装核对，完整离线校验通过。发布清单见 `../../releases/2026-09-23-kibu10/manifest.json`。
...
2026-09-23：0.1.39 将颜色切换从强制段落边界判据中移除，逐字保留高亮；s15:1178 的下落不明了。保持同一行，并覆盖先前自首后句号的问题。明确句末、缩进、独立段落及原点击停顿仍保留。全量实际文本包回归验证控制与颜色一致。
