...
stay in the fifth-game project; sibling caches are read-only SHA-256 seeds. The original
...
def ensure_dependency(item):
    ...
    candidates = [cached]
    for name in ("04-shirasagi", "03-shisha-no-rakuen", "02-kairou", "01-kamen-gensou"):
...
def build_font(pack, output):
    ...
    notice = ("Kibu5 Dialogue Pixel 16 - a subset/format conversion of GNU Unifont " + lock["version"] + "\n"
