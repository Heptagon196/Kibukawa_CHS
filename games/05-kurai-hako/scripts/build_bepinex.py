"""Build and validate the kibu5 runtime translation without installing/launching."""
import argparse
import base64
import collections
import io
...
def main():
    ...
    payload['README_Kibu5_汉化安装.txt'] = p.WORK/'bepinex/README_INSTALL.txt'
    ...
    archive = release/'Kibu5_ZhCN_BepInEx_Full.zip'
