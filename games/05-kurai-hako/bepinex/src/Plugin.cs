...
namespace Kibu1ZhCN
{
    ...
    {
        public const string Id = "local.kibu5.zhcn";
        ...
        private void Awake()
        {
            ...
            try
            {
                ...
                string managed = Path.Combine(Paths.GameRootPath, "kibu5_Data", "Managed", "Assembly-CSharp.dll");
                string archive = Path.Combine(Paths.GameRootPath, "kibu5_Data", "StreamingAssets", "scratchpad");
