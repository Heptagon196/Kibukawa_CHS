...
{
    public abstract class Gmode20050817HistoryRuntime : HistoryView
    {
        protected virtual string TranslateSpeaker(string speaker) { return speaker; }
        private static Gmode20050817HistoryRuntime self;
        ...
        protected void InitializeHistory()
        {
            ...
            try
            {
                ...
                foreach (Type type in CanvasDiscovery.Resolve(AccessTools.TypeByName))
                {
                    ...
                    foreach (string field in new[] { "FrameTask", "MainTask", "Script", "BunsyouGun_gyousuu", "bg_itigyougun_mojiretu", "bg_itigyougun_color", "ColorTable", "NowNamae", "Namae_nafuda", "Namae_color", "command" })
                    ...
                    Patch(type, "Game", null, "AfterScript");
                    Patch(type, "Game_adv", null, "AfterScript");
        ...
        private void Patch(Type type, string name, string prefix, string postfix)
        {
            ...
            var after = postfix == null ? null : new HarmonyMethod(typeof(Gmode20050817HistoryRuntime), postfix) { priority = Priority.Last };
            harmony.Patch(method, prefix == null ? null : new HarmonyMethod(typeof(Gmode20050817HistoryRuntime), prefix), after, null, null, null);
        }
