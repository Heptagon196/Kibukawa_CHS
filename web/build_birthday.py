...
def main():
    ...
    html=html.replace('</head>','<style>.message_inner,.message_inner p,.message_inner span,.glink_button {font-family:"Microsoft YaHei","PingFang SC","Noto Sans CJK SC",sans-serif !important;}</style></head>')
